...
Class CMB2Fields {
  ...
  public $cmb_prefix = '_arising_cmb2_';
  ...
  public function field($field_name, array $field_args = null) {
    ...
    if(strpos($field_name, 'image') !== false && empty($field_value) && $field_args['placeholder'] === false) {
  ...
  public function render_image_size($attachment_id, $image_size = 'full') {
